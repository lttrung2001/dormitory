package com.lttrung.dormitory.ui.adminverifyotp
...
@HiltViewModel
class AdminVerifyOtpViewModel @Inject constructor(
    private val verifyAdminUseCase: VerifyAdminUseCase
) : ViewModel() {
    ...
    internal fun verifyCode(username: String, password: String, otp: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            verifyCodeDisposable = verifyAdminUseCase.execute(username, password, otp)
